...
Prefer the full walkthrough? Watch the complete run -- bootstrap, console sign-in, creating a tenant cluster, and inspecting its nodes:

<video controls width="100%" style={{maxWidth: '820px', borderRadius: '6px'}}>
  <source src={require('./demo.mp4').default} type="video/mp4" />
  Your browser does not support the video tag. <a href={require('./demo.mp4').default}>Download the demo.</a>
</video>
